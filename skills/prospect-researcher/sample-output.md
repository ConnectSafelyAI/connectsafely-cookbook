...
## Recent activity
1. **Post** (294 likes, 48 comments) — https://www.linkedin.com/feed/update/urn:li:activity:7454016180836802560
...
2. **Post** (915 likes, 125 comments) — https://www.linkedin.com/feed/update/urn:li:activity:7453877655780712448
...
3. **Post** (3074 likes, 316 comments) — https://www.linkedin.com/feed/update/urn:li:activity:7453658782334730241
...
4. **Post** (1412 likes, 221 comments) — https://www.linkedin.com/feed/update/urn:li:activity:7453291761340391424
   > This World Immunization Week, it's worth reflecting on just how far we've come. Over the last 25 years, under-five deaths have fallen faster than any other time in history. This unbelievable progress is due in part to global partnerships, l…
...
> Hi Bill, reference their post: "dr. damaris matoke-muhia lost her younger brother to malaria as a child. today, she's one of the scientists leading the fight to end…" — would love to swap notes if you're open to it.

---

## JSON mode

`python example.py <url> --json` returns the same data as a JSON object with keys: `snapshot`, `background`, `recent_posts`, `conversation_hooks`, `suggested_dm`. Useful for piping into agents or downstream tooling.
